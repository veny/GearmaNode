...
var Client = exports.Client = function(options) {
    ...
    for (i = 0; i < this.jobServers.length; i ++) {
        this.jobServers[i].client = this; // bidirectional association management
    }
...
Client.prototype.getStatus = function(job) { // #unit: TODO test it
    ...
    return jobServer.send(protocol.encodePacket(protocol.PACKET_TYPES.GET_STATUS, 'ascii', [job.handle]));
}
