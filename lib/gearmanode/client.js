 ...
 * @param {boolean} options.background flag whether the job should be processed in background/asynchronous, Optional
 * @param {string} options.priority priority in job server queue, Optional, 'HIGH'|'NORMAL'|'LOW'
