...
exports.DEFINITION = {
    ...
    WORK_STATUS: [12, constants.TYPE_REQ],          // W->J/C: HANDLE[0]NUMERATOR[0]DENOMINATOR
    WORK_COMPLETE: [13, constants.TYPE_REQ],        // W->J/C: HANDLE[0]RES
    GET_STATUS: [15, constants.TYPE_REQ],           // C->J: HANDLE
    SUBMIT_JOB_BG: [18, constants.TYPE_REQ],        // C->J: FUNC[0]UNIQ[0]ARGS
    ERROR: [19, constants.TYPE_RESP, 'nL'],         // J->C: ERRCODE[0]ERR_TEXT
    ...
    // --
    WORK_FAIL: [14, constants.TYPE_REQ],
...
exports.encodePacket = function (packetType, encoding, args) {
    ...
    buff = new Buffer(12 + packetLength);
    ...
    logger.log('debug', 'packet encoded, type=%s, buffer.size=%d',
        exports.PACKET_CODES[packetType], packetLength + 12);
    return buff;
}
