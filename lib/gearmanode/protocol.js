...
exports.DEFINITION = {
    ...
    WORK_EXCEPTION: [25, constants.TYPE_REQ | constants.TYPE_RESP, 'nL'],   // W->J/C: HANDLE[0]ARG
    OPTION_REQ: [26, constants.TYPE_REQ],           // C->J: TEXT
    OPTION_RES: [27, constants.TYPE_RESP, 'L'],     // J->C: TEXT
    WORK_DATA: [28, constants.TYPE_REQ | constants.TYPE_RESP, 'nL'],        // W->J/C: HANDLE[0]RES
    WORK_WARNING: [29, constants.TYPE_REQ | constants.TYPE_RESP, 'nL'],     // W->J/C: HANDLE[0]MSG
...
exports.parsePacket = function (buff, format) {
    ...
    for (i = 0; i < format.length; i ++) {
        ...
        if ('N' == key || 'n' == key) {
            ...
            rslt[i + 1] = buff.toString('binary', offset, packetLength);
            offset = packetLength;
