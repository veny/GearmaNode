...
JobServer.prototype._processData = function (chunk) {
    ...
    if (protocol.CONSTANTS.TYPE_RESP & protocol.DEFINITION[packetCode][1]) {
        parsed = protocol.parsePacket(chunk, protocol.DEFINITION[packetCode][2]);
    ...
    case protocol.PACKET_TYPES.WORK_COMPLETE:
        this.mate.response(packetType, parsed);
