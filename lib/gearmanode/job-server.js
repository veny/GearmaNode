 ...
 *     * connection done with 'self' instance as parameter
 *     * connection fails with an Error as parameter
 */
...
JobServer.prototype.submit = function (job, callback) { // #unit: TODO test it
    var self = this;
