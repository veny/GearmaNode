...
var Worker = exports.Worker = function(options) {
    ...
    returned = this.initServers(this, options);
...
Worker.prototype.addFuntion = function(name, callback, options) { // #unit: TODO test it
    var jobServer;
    if (name === undefined) { return new Error('undefined function name'); }
 ...
 */
Worker.prototype.getFunction = function (name) {
 ...
 */
Worker.prototype._preSleep = function (jobServer) {
