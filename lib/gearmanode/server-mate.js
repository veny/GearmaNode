...
var ServerMate = exports.ServerMate = function(options) {
    ...
    for (var i = 0; i < options.servers.length; i ++) {
        ...
        jobServer.mate = this; // bidirectional association management
...
// static logger
ServerMate.logger = winston.loggers.get('ServerMate');


/**
 * Processes an error that cannot be
 */
ServerMate.prototype._unrecoverableError = function (msg) { // #unit: not needed
    ServerMate.logger.log('error', msg);
